...
public class TransactionalServiceIntegrationTests {
  ...
  public void setUp() {
    ...
    List<String> statements =
        Arrays.asList(
            ...
            "CREATE TABLE customer ( id BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT, firstname VARCHAR(100) NOT NULL, "
                + "lastname VARCHAR(100) NOT NULL, age INTEGER);");
  ...
  public void exceptionTriggersRollback() {
    ...
    service
        .save(new Customer(null, "Dave", "Matthews", 20))
        .as(StepVerifier::create)
        .expectError() // Error because of the exception triggered within the service
        .verify();

    // No data inserted due to rollback
    repository.findByLastname("Matthews").as(StepVerifier::create).verifyComplete();
  }
  ...
  public void insertsDataTransactionally() {
    ...
    service
        .save(new Customer(null, "Carter", "Beauford", 25))
        .as(StepVerifier::create)
